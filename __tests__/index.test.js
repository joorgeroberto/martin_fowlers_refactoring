...
const { covertToOrdinalNubmer } = require("../src/utils/helpers");
...
describe("Statement function tests", () => {
  const BigCo = invoices.find(({ customer }) => customer === "BigCo");
  test(`should be able to pass in BigCo test`, () => {
    expect(statement(BigCo, plays)).toBe(
